...
void				ft_lstdelone(t_tet **alst, void (*del)(void *, size_t));
void				ft_lstdel(t_tet **alst, void (*del)(void *, size_t));
void				ft_lstadd(t_tet **alst, t_tet *new);
void				ft_lstiter(t_tet *lst, void (*f)(t_tet *elem));
t_tet			*ft_lstmap(t_tet *lst, t_tet *(*f)(t_tet *elem));
